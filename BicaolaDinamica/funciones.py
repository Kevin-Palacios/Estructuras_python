...
def encolarIzq(cola, datoIngreso):
    colaAux = crearCola()
    ...
    if(estaVacia(cola)):
        ...
        #colaAux.final=cola.final
        encolar(colaAux, datoIngreso)
        while(cola.cursor!=0):
            nodousuario.dato=desencolar(cola, nodousuario.dato)
            encolar(colaAux, nodousuario.dato)
